            ...
            <div id="elem" style={{marginBottom: '20px', height:'100%'}} className="col-sm">
                <div class="card" style={{width: "18rem"}}>
                    ...
                    <div style={{display:'flex', flexDirection:'row', justifyContent: 'center'}} class="card-body">
                        ...
                        <Link class="card-text" to={"tv/"+this.props.id} style={{width:'fit-content', height:'fit-content', padding:'10px',textAlign: "center", color: "black", border:'1px solid', boxShadow:'5px 10px'}}>{this.props.name}</Link>
                    </div>
                </div>
            </div>
        );
